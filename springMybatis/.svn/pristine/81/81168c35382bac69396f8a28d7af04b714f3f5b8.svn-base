...
<link rel="stylesheet" href="css/taobao/evaluation.css" type="text/css"></link>
...
<script type="text/javascript" src="js/taobao/buildEval.js"></script>
<script type="text/javascript" src="js/taobao/evaluation.js"></script>
</head>
			...
			<div id="navbg">
				<p id="loginInfo">
					...
					<a id="regist" class="a_link"
						...
						href="javascript:void(0);" id="exit">退出</a> <a
