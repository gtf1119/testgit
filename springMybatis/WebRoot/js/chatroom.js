$(function() {
	...
	//自提加粗
	$("#jc").click(function(){
		$(".msgContent").css("font-weight","bold");
	});
	//双击自提还原
	$("#jc").dblclick(function(){
		$(".msgContent").css("font-weight","");
	});
	
	//设置字体颜色
	$("#foo").click(function(){
		$(".msgContent").css("color",$("#foo").css("background-color"));
	});
